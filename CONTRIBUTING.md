...
## [Questions/Problems](https://github.com/AppleGamer22/scr-cli/discussions)
...
* [General](https://github.com/AppleGamer22/scr-cli/discussions/categories/general)
* [Ideas](https://github.com/AppleGamer22/scr-cli/discussions/categories/ideas)
  * Discussion categories changes should be suggested here.
* [Q&A](https://github.com/AppleGamer22/scr-cli/discussions/categories/q-a)
* [Show & Tell](https://github.com/AppleGamer22/scr-cli/discussions/categories/show-tell)
...
git clone https://github.com/AppleGamer22/scr-cli
# Navigate to the newly cloned directory
cd scr-cli
# Assign the original repo to a remote called "GitHub"
git remote add GitHub https://github.com/AppleGamer22/scr-cli
...
## [Bug Reports/Feature Requests](https://github.com/AppleGamer22/scr-cli/issues)
...
indent_size = 2
```
## [License](https://github.com/AppleGamer22/scr-cli/blob/master/LICENSE.md)
